...
// */
//public class GraphicsFacadeOld {
//
...
//    private static final Logger LOGGER = Logger.getLogger(GraphicsFacadeOld.class.getName());
//    private static final Font DEFAULT_MENU_FONT = new TrueTypeFont(new Font(Configuration.MENU_FONT_NAME,
//            Configuration.MENU_FONT_STYLE, Configuration.MENU_FONT_SIZE), false);
//    private static final Font DEFAULT_FIELD_FONT = new TrueTypeFont(new Font(Configuration.FIELD_FONT_NAME,
//            Configuration.FIELD_FONT_STYLE, Configuration.FIELD_FONT_SIZE), false);
//    private static final Font MOUSE_OVER_MENU_FONT = new TrueTypeFont(new Font(Configuration.MENU_FONT_NAME,
//            Configuration.MENU_FONT_MOUSE_OVER_STYLE, Configuration.MENU_MOUSE_OVER_FONT_SIZE), false);
//    private Image BGImage;
//
//    private boolean done = false;
//
//    public GraphicsFacadeOld() {
//    }
//
...
//    }
//
//    private int drawTable(GearTable item, ComponentListener listener, int initialX, int initialY, int availableWidtht) {
